...
const posts: PostMeta[] = [
  ...
  { slug: 'it-a-coisa', locale: 'pt-BR', publishedAt: '2025-08-17' },
  { slug: 'escuridao-total-sem-estrelas', locale: 'pt-BR', publishedAt: '2025-09-09' },
  { slug: 'a-longa-marcha', locale: 'pt-BR', publishedAt: '2025-10-12' },
  { slug: 'carrie', locale: 'pt-BR', publishedAt: '2025-11-16' },
  { slug: 'o-planeta-dos-macacos', locale: 'pt-BR', publishedAt: '2026-01-20' },
  { slug: 'battle-royale', locale: 'pt-BR', publishedAt: '2026-02-14' },
  { slug: 'themes', locale: 'pt-BR', publishedAt: '2026-03-02' },
  { slug: 'intro-sharks', locale: 'pt-BR', publishedAt: '2026-03-18' },
  { slug: 'o-poderoso-chefao', locale: 'pt-BR', publishedAt: '2026-04-06' },
  { slug: 'anatomia-dos-tubaroes', locale: 'pt-BR', publishedAt: '2026-04-24' },
  { slug: 'sentidos-dos-tubaroes', locale: 'pt-BR', publishedAt: '2026-05-13' },
  { slug: 'comportamento-dos-tubaroes', locale: 'pt-BR', publishedAt: '2026-06-02' },
  { slug: 'evolucao-e-reproducao-dos-tubaroes', locale: 'pt-BR', publishedAt: '2026-06-21' },
  { slug: 'taxonomia-dos-tubaroes', locale: 'pt-BR', publishedAt: '2026-07-16' },
  { slug: 'tubaroes-e-humanos', locale: 'pt-BR', publishedAt: '2026-08-08' },
  // en posts
  ...
  { slug: 'it', locale: 'en', publishedAt: '2025-08-17' },
  { slug: 'full-dark-no-stars', locale: 'en', publishedAt: '2025-09-09' },
  { slug: 'the-long-walk', locale: 'en', publishedAt: '2025-10-12' },
  { slug: 'carrie', locale: 'en', publishedAt: '2025-11-16' },
  { slug: 'planet-of-the-apes', locale: 'en', publishedAt: '2026-01-20' },
  { slug: 'battle-royale', locale: 'en', publishedAt: '2026-02-14' },
  { slug: 'themes', locale: 'en', publishedAt: '2026-03-02' },
  { slug: 'intro-sharks', locale: 'en', publishedAt: '2026-03-18' },
  { slug: 'the-godfather', locale: 'en', publishedAt: '2026-04-06' },
  { slug: 'shark-anatomy', locale: 'en', publishedAt: '2026-04-24' },
  { slug: 'shark-senses', locale: 'en', publishedAt: '2026-05-13' },
  { slug: 'shark-behavior', locale: 'en', publishedAt: '2026-06-02' },
  { slug: 'shark-evolution-and-reproduction', locale: 'en', publishedAt: '2026-06-21' },
  { slug: 'shark-taxonomy', locale: 'en', publishedAt: '2026-07-16' },
  { slug: 'sharks-and-humans', locale: 'en', publishedAt: '2026-08-08' },
]
