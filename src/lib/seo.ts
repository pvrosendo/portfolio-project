...
export const SITE_NAME = 'Paulo Vitor · O Códex'
  ...
  return JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: SITE_URL,
        name: SITE_NAME,
        description: 'Paulo Vitor — Software Developer. Exploring the depths of software engineering.',
...
export function buildBlogPostingJsonLd(post: Post) {
  return JSON.stringify({
    ...
    ...(post.coverImage ? { image: post.coverImage } : { image: DEFAULT_OG_IMAGE }),
  })
}
